...
def poll_for_review(
    document_id: str,
    api_key: str,
    base_url: str = "https://api.documind.cloud/api/v1",
...
if result["needs_review"]:
    print("⚠️  Document needs human review - direct team to: https://app.documind.cloud/review")
...
async function pollForReview(
  documentId: string,
  apiKey: string,
  baseUrl: string = "https://api.documind.cloud/api/v1",
