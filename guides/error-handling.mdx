...
```json
{
  ...
  "allowed_values": ["google-gemini-3-flash", "google-gemini-2.5-flash", "qwen-3-vl"]
}
```
...
```json
{
  "detail": "Invalid model name: gpt-5. Allowed values: ['google-gemini-3-flash', 'google-gemini-2.5-flash', 'qwen-3-vl']"
}
```
...
class ExtractionMode:
    QWEN_3_VL = "qwen-3-vl"  # 2 credits/page
    GEMINI_2_5_FLASH = "google-gemini-2.5-flash"  # 4 credits/page
    GEMINI_3_FLASH = "google-gemini-3-flash"  # 6 credits/page
...
def validate_extraction_request(document_id, schema, model=None):
    ...
    valid_models = ["google-gemini-3-flash", "google-gemini-2.5-flash", "qwen-3-vl"]
...
<CardGroup cols={2}>
<Card title="Automation Pipeline" icon="diagram-project" href="/api/patterns/automation-pipeline">
